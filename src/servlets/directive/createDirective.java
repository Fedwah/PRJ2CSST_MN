...
public class createDirective extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 {
	 PageGenerator pg = new PageGenerator("/WEB-INF/vues/directives/createDirective.jsp", "Cr�er une directive");
	 ...
	 pg.generate( getServletContext(), request, response );
		 ...
		 {
			 PageGenerator pg = new PageGenerator("/WEB-INF/vues/directives/createDirectiveReg.jsp","Cr�er une directive");
