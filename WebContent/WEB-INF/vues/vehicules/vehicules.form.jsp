...
<head>
<meta charset="UTF">
<title>Creation d'un vehicules</title>
...
<body>
	<div class="container-fluid">
		<form class="p-5 needs-validation " method="post"
			action="<c:out value="add"/>" novalidate
			...
			<div class="form-row">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							<label for="etat">Etat</label> <select id="etat"
								...
								<option selected}>En fonction </option>
				...
				<div class="form-group col-md-3">
					...
					<div class="custom-file" >
						...
						<label class="custom-file-label" for="photo">Importer une image</label>
					</div>
